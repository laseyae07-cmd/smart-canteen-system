...
const KitchenDashboard = () => {
  ...
  if (loading) {
    return <div className="text-center text-xl font-semibold text-gray-700">Loading orders...</div>;
  }

  return (
    <div className="rounded-2xl bg-white p-8 shadow-lg">
      <h1 className="text-3xl font-bold text-red-600">Kitchen Dashboard</h1>
      <p className="mt-2 text-gray-600">Live order tracking for staff.</p>
